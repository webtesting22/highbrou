...
const OurTeamFounders = () => {
  ...
  const InverstorsDetails = [
    ...
    {
      image:
        "https://s3.ap-south-1.amazonaws.com/prepseed/prod/ldoc/media/Shaikh Ismail.png",
      name: "Shaikh Ismail",
      position: "Director",
      tagline:
        "A finance expert with extensive experience in project development, driving strategic growth at Highbrou Engineering.",
      details: (
        <>
          <p>
    ...
    },
    {
      ...
      tagline:
        "A business graduate specializing in real estate markets, enhancing project feasibility and development strategies at Highbrou Engineering.",
      details: (
        <>
          <p>
        ...
        <div>
          <div className="sectionPadding">
            ...
            <div className="OurInverstorsContentContainer">
              <div
                className="FoundersAnimatedCards"
